...
public interface IPreseleccionService
{
    Task<OfertaResponseDto> GetOfertaAsync(
        ...
        int page = 1,
        int itemsPerPage = 5);
    Task<AccionPreseleccionResponseDto> GuardarPreseleccionAsync(int usuarioId, int seccionId);
    ...
    Task<AccionPreseleccionResponseDto> FinalizarPreseleccionAsync(int usuarioId);
}
