...
public static class DataSeeder
{
    public static void SeedData(SistemaAcademicoContext appContext)
    {
        ...
        */
        ...
        // Seeding de UsuarioRol
        if (!appContext.UsuarioRols.Any())
        {
            appContext.UsuarioRols.AddRange(IdentityAccessUsersData.GetUsuarioRoles());
        }

        // Seeding de UsuarioAreaAcademica
        if (!appContext.UsuarioAreaAcademicas.Any())
        {
            appContext.UsuarioAreaAcademicas.AddRange(IdentityAccessUsersData.GetUsuarioAreaAcademicas());
        }
        #endregion
